...
const { Users, Organizations, Programs, News } = require("../../models");
    ...
    for (let i = 0; i < 20; i++) {
        DonationSamples.forEach(async (d) => {
            ...
            return Programs.findById(progID)
                ...
                .then((u) => {
                    u.history.push(
                        `Program: ${progID} - Donation: ${donations_id} - Payment: Clone Auto`
                    );
                    u.save();
                })
