...
export const CreateCollection = (type, data) =>
    console.log(
        `You created ${type} collection to url: http://localhost:5000/add${type}, with data: `,
        data
    );

export const UpdateCollection = (type, data) =>
    console.log(
        `You updated ${type} collection, with _id: ${data._id}, and data: `,
        data
    );

export const DeleteCollection = (type, id) =>
    console.log(`You deleted ${type} collection, with _id: `, id);

export const PostImg = ([data]) =>
    setTimeout({ url: "asset/img/boat.png", file: data }, 1000);
