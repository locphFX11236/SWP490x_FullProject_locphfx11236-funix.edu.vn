...
export const ProgramsColumns = [
    ...
    getColumn("Admin", "management", {
        render: (value, record, index) => (
            <ShowAdminActions value={value} record={record} />
        ),
    }),
    getColumn("Quyên góp", "donations", {
        render: (value, record, index) => (
            <ShowDonasActions value={value} record={record} />
        ),
    }),
    getColumn("Action", "key", {
        render: (value, record, index) => <ProgramActions record={record} />,
    }),
];
...
export const UsersColumns = [
    ...
    getColumn("History", "history", {
        render: (value, record, index) => (
            <ShowActionHistory value={value} record={record} />
        ),
    }),
    getColumn("Action", "key", {
        render: (value, record, index) =>
            record.isAdmin ? "Admin" : <UserActions record={record} />,
    }),
];
